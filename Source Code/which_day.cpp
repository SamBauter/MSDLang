...
int main(int argc, char **argv) {
  ...
  std::ifstream dotfile("/Users/samuelbauter/SamBauter/CS6015/MSDLang/MSDLang/which_day2");
  ...
  std::cout << "The meeting day for week " << argv[1]
            << " is:\n\n"
            << e->interp(NEW(EmptyEnv)())->to_string() << "\n";
